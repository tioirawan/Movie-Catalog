...
public class MoviesFragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    private final MoviesViewModel.FailureListener failureListener = t -> Toast.makeText(getActivity(), t.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mMovieViewModel = ViewModelProviders.of(this, factory).get(MoviesViewModel.class);
